...
function eventHandler() {
	...
	var swiper11 = new Swiper('.headerBlock__slider--js', _objectSpread(_objectSpread({}, defaultSl), {}, {
		spaceBetween: 20,
		slidesPerView: 1,
		navigation: {
			nextEl: '.headerBlock__slider--js .swiper-button-next',
			prevEl: '.headerBlock__slider--js .swiper-button-prev'
		}
	}));
	var swiper4 = new Swiper('.step-item__slider--js', _objectSpread(_objectSpread({}, defaultSl), {}, {
		spaceBetween: 20,
		slidesPerView: 1,
		navigation: {
